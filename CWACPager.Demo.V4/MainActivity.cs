...
namespace CommonsWare.CWAC.Pager.Demo.V4
{
    [Activity(Label = "@string/app_name", MainLauncher = true)]
    public class MainActivity : AppCompatActivity
    {
        CommonsWare.CWAC.Pager.V4.ArrayPagerAdapter _adapter = null;
        ...
        CommonsWare.CWAC.Pager.V4.ArrayPagerAdapter BuildAdapter()
        {
            ...
            return new SamplePagerAdapter(SupportFragmentManager, pages);
        }
        ...
        class SamplePagerAdapter : CommonsWare.CWAC.Pager.V4.ArrayPagerAdapter
        {
